...
const InReviewProjects = ({ data }) => {
  ...
  const inReviewProjects = data?.transactions.filter(tr => tr.status === 1) || [];
  console.log('in review projects: ', inReviewProjects);
  ...
  if (inReviewProjects.length === 0) {
    return (
      <Box sx={{ textAlign: 'center', marginTop: '20px' }}>
        <Typography>No in review projects found.</Typography>
      </Box>
    );
  }
...
export default InReviewProjects;