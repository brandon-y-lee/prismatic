...
import FundingDataGrid from 'components/funds/FundingDataGrid';
...
const Funding = () => {
  ...
  useEffect(() => {
    if (selectedAccount) {
      console.log("Transactions Data For Selected Account: ", transactionsData[selectedAccount]);
    }
  }, [transactionsData, selectedAccount]);
      ...
      <Box m="1.5rem 2.5rem">
        <FlexBetween>
          ...
          <AccountSwitcher
            ...
            openDialog={handleOpenBankDialog}
          />
          <BankSelection
